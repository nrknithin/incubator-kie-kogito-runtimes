    ...
    public <T> T unmarshall(S input, Class<T> outputClass, Class<?>... parametrizedClasses) throws IOException {
        if (input == null) {
            ...
            try {
                ...
                // Jackson 3 readValue throws JacksonException (RuntimeException); the
                // EventUnmarshaller contract uses IOException for format issues so
                // callers can differentiate them from unexpected errors.
